...
export default function Home() {
  ...
  // Temporary CTA colours while the picker is open
  const [ctaBgDrafts, setCtaBgDrafts] = useState<Record<number, string>>({});
          ...
          <div className="accordion-content">
            ...
            {section.products.some((p) => p.cta) && (
              ...
              >
                ...
                <input
                  type="color"
                  defaultValue={section.ctaBg}
                  onInput={(e) => {
                    const val = e.currentTarget.value;
                    setCtaBgDrafts((prev) => ({ ...prev, [section.id]: val }));
                    // Keep the picker open so users can try multiple colours
                    // without it closing after each selection.
                  ...
                  onBlur={() => {
                    setBodySections((prev) =>
                      prev.map((s) =>
                        s.id === section.id
                          ? { ...s, ctaBg: ctaBgDrafts[section.id] ?? s.ctaBg }
                          : s
                      )
                    );
                    setCtaBgDrafts((prev) => {
                        ...
                        {section.products.map((prod, idx) => {
                          ...
                          return (
                            <ProductTableModule
                              ...
                              ctaBg={ctaBgDrafts[section.id] ?? section.ctaBg}
                            />
                          );
                        })}
                      </div>
